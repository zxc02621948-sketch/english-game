/* ============================================================================
   ...
   ============================================================================ */
const BANK = [
  { id:"word_cat",        en:"cat",        zh:"貓",     pos:"noun", flags:["countable","ownable","presentable"], syl:["cat"], why:"短字先暖身:cat 就是貓。" },
  ...
  { id:"word_friend",     en:"friend",     zh:"朋友",   pos:"noun", flags:["countable","ownable","presentable"], syl:["friend"], why:"friend 是你認識、信任、會來往的人。" },
  { id:"word_book",       en:"book",       zh:"書",     pos:"noun", flags:["countable","ownable","readable","presentable"], syl:["book"], why:"book 是書;生活裡也能當動詞,表示預訂。" },
  ...
  { id:"word_house",      en:"house",      zh:"房子",   pos:"noun", flags:["countable","ownable","presentable"], syl:["house"], why:"house 重點是建築物:一棟可以住人的房子。" },
