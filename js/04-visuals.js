...
const EMOJI = {
  ...
  word_eat:"🍽️", word_drink:"🥤", word_go:"🚶", word_buy:"🛒",
  word_hello:"👋", word_music:"🎵",
...
const IMG = { word_house:'img/house.png', word_home:'img/home.png', word_big:'img/big.png', word_small:'img/small.png', word_beautiful:'img/beautiful.png', word_get:'img/get.png', word_sugar:'img/sugar.png', word_friend:'img/friend.png' };   // project/experience 已移出日常軌,圖檔留在 img/ 之後工作軌可用   // sugar:一碗白方糖(砂糖,不是 candy 糖果)—— 取代先前誤導的 🍬   // get:手接住箱子(往手裡收 = 得到)。⚠ 之後加 take/bring 的圖要畫不同方向,別三個手混一起
