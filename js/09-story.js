...
const STORIES = [
  {
    ...
    script: [
      ...
      { type: 'line', who: 'N', words: [['The', '那隻', { fresh: 1 }], ['dog', '狗', { fresh: 1 }], ['drinks', '喝了', { fresh: 1, why: 'drink 的現在式,狗「喝掉」了' }], ['the', '那杯', { fresh: 1 }], ['coffee', '咖啡'], ['!', '']] },
      { type: 'ask', q: '誰喝了咖啡?', options: [{ t: '那隻狗', ok: true }, { t: 'Sam' }, { t: '沒有人' }] },
      { type: 'line', who: 'S', side: 'L', words: [['...', ''], ['Tea', '茶'], [',', ''], ['please', '請'], ['.', '']] },
      { type: 'line', who: 'N', words: [['The', '那隻'], ['dog', '狗', { fresh: 1 }], ['drinks', '喝了', { fresh: 1 }], ['the', '那杯'], ['tea', '茶'], [',', ''], ['too', '也', { fresh: 1 }], ['!', '']] },
      { type: 'line', who: 'S', side: 'L', words: [['Water', '水'], [',', ''], ['please', '請'], ['!', '']] },
      { type: 'line', who: 'N', words: [['The', '那隻'], ['dog', '狗', { fresh: 1 }], ['is', '是'], ['full', '喝飽了', { fresh: 1, why: 'full=滿的;肚子滿了 = 喝飽/吃飽' }], ['.', '']] },
      { type: 'ask', q: '狗為什麼不喝水?', options: [{ t: '咖啡和茶都被牠喝光,喝飽了', ok: true }, { t: '牠不喜歡水的顏色' }, { t: '牠想找 Sam 玩' }] },
      { type: 'line', who: 'S', side: 'L', words: [['Finally', '終於', { fresh: 1 }], ['!', ''], ['Water', '水'], [',', ''], ['please', '請'], ['.', '']] },
      { type: 'line', who: 'N', words: [['Sam', '山姆'], ['drinks', '喝了', { fresh: 1 }], ['the', '那杯'], ['water', '水'], ['.', '']] },
      { type: 'line', who: '🐶', side: 'R', words: [['...', ''], ['Sorry', '對不起', { fresh: 1 }], ['!', '']] },
      { type: 'ask', q: '這個故事的重點?', options: [{ t: '狗把 Sam 的咖啡和茶都偷喝光,Sam 只好喝水', ok: true }, { t: 'Sam 不喜歡咖啡' }, { t: '那隻狗是咖啡店店員' }] },
    ],
  },
  {
